...
def main():
    parser = argparse.ArgumentParser(description="PyTorch DFPENetV3Plus Training")
    ...
    parser.add_argument('--dataset', type=str, default='landslide',
                        choices=['pascal', 'coco', 'cityscapes','vaihingen','landslide'],
    ...
    if args.checkname is None:
        args.checkname = 'DFPENet-'+str(args.backbone)
    print(args)
